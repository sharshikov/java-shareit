...
public class BookingServiceImpl implements BookingService {
    ...
    public BookingServiceImpl(BookingRepository bookingRepository, ItemRepository itemRepository, UserRepository userRepository, BookingMapper bookingMapper) {
    ...
    public BookingOutDto createBooking(Integer userId, BookingInDto bookingInDto) {
        ...
        Booking booking = bookingMapper.toEntity(bookingInDto);
